...
operator    A control operator or a redirection operator. See Section 3.6 [Redirections], page 35, for a list of redirection operators.  Operators contain at least one unquoted metacharacter.
